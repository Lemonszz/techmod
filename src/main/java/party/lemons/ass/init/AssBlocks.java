...
{
	public static final FueledFurnaceBlock SCORCHED_FURNACE = new FueledFurnaceBlock(RecipeType.SMELTING, Util.lazy(()->AssBlockEntities.FUELED_SMELTING_FURNACE), settings(Material.METAL));
	public static final FueledFurnaceBlock SCORCHED_SMOKER = new FueledFurnaceBlock(RecipeType.SMOKING, Util.lazy(()->AssBlockEntities.FUELED_SMOKER), settings(Material.METAL));
	public static final FueledFurnaceBlock SCORCHED_BLAST_FURNACE = new FueledFurnaceBlock(RecipeType.BLASTING, Util.lazy(()->AssBlockEntities.FUELED_BLAST_FURNACE), settings(Material.METAL));
